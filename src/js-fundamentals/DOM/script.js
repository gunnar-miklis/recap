...
const firstSection = document.querySelector('body > div > section:nth-child(1)');
...
const evenDivs = document.querySelectorAll('.section:nth-child(7) div:nth-child(even)');
...
fetchApiButton.onclick = () => fetchAPI('https://api.spacexdata.com/v4/launches');
