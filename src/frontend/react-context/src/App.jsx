...
function App() {
	return (
		<>
			<button className='theme-switch' onClick={() => {}}>Theme</button>
			...
			<p className='text'>
				...
				eleifend, velit non accumsan ultrices, tortor nulla elementum
				nibh, ut blandit ligula leo ac est. Phasellus eu risus nulla.
				Nullam vel tellus leo. Vivamus neque justo, mollis bibendum
				vehicula at, efficitur malesuada turpis. Phasellus congue
				ultrices tempor. Ut consectetur erat quis pretium rutrum. In hac
				habitasse platea dictumst. Quisque nec fringilla ipsum, at
				lobortis nulla.
			</p>
		</>
	);
