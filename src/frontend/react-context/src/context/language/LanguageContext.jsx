...
export default function LanguageProvider(props) {
  ...
  const [currentLanguage, setCurrentLanguage] = useState(languages[currentSelection]);
  ...
  return (
    <LanguageContext.Provider value={{ currentSelection, currentLanguage, switchLanguage }}>
      {props.children}
