...
const averageRating =
  product.reviews.reduce((avgRate, { rate: userRate }) => avgRate + userRate, 0) /
...
// 5
const numbers = [1, 60, 112, 123, 32, 100, 99, 73, 45, 23, 99, 68, 1, 0, 9, 223, 1, 1];
const oddAndGreaterFifty = numbers.filter((number) => number % 2 !== 0 && number > 50);
